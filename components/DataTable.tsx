...
import { Table as TableIcon, Search, ChevronLeft, ChevronRight, ArrowUpDown } from "lucide-react";
    ...
    >
      ...
      <div className="p-4 border-b border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white/[0.02]">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-[#FE6749]">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="rounded-full px-2 py-0.5 text-[10px] font-mono bg-white/5 border border-white/10 text-white/60">
                {sourceType === "pasted" ? "Direct Input" : "CSV Ingest"}
              </span>
            </div>
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          <div className="relative">
            ...
            <input
              ...
              className="pl-8 pr-3 py-1.5 rounded-xl bg-[#212222] border border-white/10 text-xs font-mono text-white placeholder:text-white/30 focus:outline-none focus:border-[#FE6749] w-48 sm:w-56 transition-colors"
            />
          </div>
          ...
          <div className="flex items-center gap-1.5 text-xs font-mono text-white/60">
            ...
            <select
              ...
              className="bg-[#212222] border border-white/10 rounded-lg px-2 py-1 text-xs text-white focus:outline-none focus:border-[#FE6749] cursor-pointer"
            >
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <ArrowUpDown
                        className={`w-3 h-3 transition-opacity ${
                          isSorted ? "text-[#FE6749] opacity-100" : "opacity-30 hover:opacity-70"
                        }`}
                      />
                    </div>
                  </th>
